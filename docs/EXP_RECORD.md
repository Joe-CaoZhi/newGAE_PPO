# Experimental Record: Advanced GAE Variants and DCPPO for PPO

**Project**: newGAE\_PPO
**Author**: Joe-CaoZhi
**Date**: 2024–2026
**Type**: Full Experimental Record (complete derivations, all ablations, raw results)
**Note**: For the concise ICML-style report, see `TECH_REPORT.md`
